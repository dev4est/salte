<?php
/* Smarty version 3.1.32, created on 2018-05-02 14:08:16
  from '/Users/user/Documents/project/salte/design/s-alte/html/profile/news.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5ae99c20cfdcf0_61984749',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5fa46129ce5b7b94e837dd64e4518435200a1024' => 
    array (
      0 => '/Users/user/Documents/project/salte/design/s-alte/html/profile/news.tpl',
      1 => 1525259290,
      2 => 'file',
    ),
  ),
...
function content_5ae99c20cfdcf0_61984749 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_assignInScope('nav_bar', 5);
            ...
            <div class="panel panel-flat timeline-content">
                ...
                <div class="panel-body">
                    <div class="chart-container">
                        <div class="chart has-fixed-height" id="sales" _echarts_instance_="1525258907550" style="-webkit-tap-highlight-color: transparent; user-select: none; background-color: rgba(0, 0, 0, 0); cursor: default;"><div style="position: relative; overflow: hidden; width: 740px; height: 400px;"><div data-zr-dom-id="bg" class="zr-element" style="position: absolute; left: 0px; top: 0px; width: 740px; height: 400px; user-select: none;"></div><canvas width="740" height="400" data-zr-dom-id="0" class="zr-element" style="position: absolute; left: 0px; top: 0px; width: 740px; height: 400px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></canvas><canvas width="740" height="400" data-zr-dom-id="1" class="zr-element" style="position: absolute; left: 0px; top: 0px; width: 740px; height: 400px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></canvas><canvas width="740" height="400" data-zr-dom-id="_zrender_hover_" class="zr-element" style="position: absolute; left: 0px; top: 0px; width: 740px; height: 400px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></canvas><div class="echarts-tooltip zr-element" style="position: absolute; display: block; border-style: solid; white-space: nowrap; transition: left 0.4s, top 0.4s; background-color: rgba(0, 0, 0, 0.8); border-width: 0px; border-color: rgb(51, 51, 51); border-radius: 4px; color: rgb(255, 255, 255); font-family: Roboto, sans-serif; padding: 8px 12px; left: 605px; top: 294px;">Mon<br>Profit : 200<br>Income : 320<br>Expenses : -120</div></div></div>
                    </div>
                </div>
            </div>
        </div>
