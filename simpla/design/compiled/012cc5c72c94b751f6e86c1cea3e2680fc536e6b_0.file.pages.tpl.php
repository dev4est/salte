...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  ...
  'file_dependency' => 
  array (
    '012cc5c72c94b751f6e86c1cea3e2680fc536e6b' => 
    array (
      0 => '/Users/user/Documents/project/salte/simpla/design/html/pages.tpl',
      1 => 1405446082,
      2 => 'file',
    ),
  ),
...
?>
		<li <?php if ($_smarty_tpl->tpl_vars['m']->value->id == $_smarty_tpl->tpl_vars['menu']->value->id) {?>class="active"<?php }?>><a href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('module'=>'PagesAdmin','menu_id'=>$_smarty_tpl->tpl_vars['m']->value->id),$_smarty_tpl ) );?>
...
$_smarty_tpl->_assignInScope('meta_title', $_prefixVariable1 ,false ,2);?>

<div id="header">
	<h1><?php echo $_smarty_tpl->tpl_vars['menu']->value->name;?>
</h1>
	<a class="add" href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('module'=>'PageAdmin'),$_smarty_tpl ) );?>
">Добавить страницу</a>
</div>
...
" />				
				...
				<div class="name cell">
					<a href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('module'=>'PageAdmin','id'=>$_smarty_tpl->tpl_vars['page']->value->id,'return'=>$_SERVER['REQUEST_URI']),$_smarty_tpl ) );?>
